...
topic_temp = "326project/smartbuilding/hvac/0/8/temperature"
topic_humid = "326project/smartbuilding/hvac/0/8/humidity"
topic_smoke = "326project/smartbuilding/safety/0/8/smoke"
topic_pressure = "326project/smartbuilding/hvac/0/8/pressure"
topic_fireAlarm = "326project/smartbuilding/safety/0/8/firealarm"
topic_sprinkler = "326project/smartbuilding/safety/0/8/sprinkler"
topic_pullStation = "326project/smartbuilding/safety/0/8/pullstation"
topic_fireAlarm = "326project/smartbuilding/safety/0/8/firealarm"
...
while(1):
	...
	#publish sprinkler status
	sprinkler = {
            "time":"test_time",
            "state": random.randint(0,1)
        }

	payload_sprinkler = json.dumps(sprinkler)
	client.publish(topic_sprinkler, payload=payload_sprinkler, qos=0, retain=False)
	print("Published", payload_sprinkler)

    #publish pullStation status
	pullStation = {
            "time":"test_time",
            "state": random.randint(0,1)
        }

	payload_pullStation = json.dumps(pullStation)
	client.publish(topic_pullStation, payload=payload_pullStation, qos=0, retain=False)
	print("Published", payload_pullStation)
